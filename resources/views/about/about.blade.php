...
<main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url({{ asset('image/img-blank.png') }})"></div>
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row position-relative">
                ...
                <div class="col-lg-7 about-img" style="background-image: url({{ asset('image/img-blank.png') }})"></div>
                <div class="col-lg-7">
